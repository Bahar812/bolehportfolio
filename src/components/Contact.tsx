  ...
  return (
    <section id="contact" className="py-20 bg-gray-900 px-4">
      <div className="container max-w-5xl mx-auto">
        ...
        <div className="bg-gray-800 rounded-lg p-8 md:p-12 max-w-3xl mx-auto shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <a 
                href="mailto:baharalhamid410@gmail.com"
                className="bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white font-medium py-3 px-6 rounded-lg text-center transition-all duration-300 transform hover:scale-105"
              >
                Send a Message
              </a>
            </div>
